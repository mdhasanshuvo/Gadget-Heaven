    ...
    return (
        <div>
            ...
            '>Dashboard</h2>
                ...
                <NavLink onClick={handleCart} className="btn btn-outline rounded-xl m-3 text-white">Cart</NavLink>
                <NavLink onClick={handleWish} className="btn btn-outline rounded-xl m-3 text-white">Wishlist</NavLink>
            </div>
            {showCart && <Cart></Cart>}
